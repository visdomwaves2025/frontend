...
const ProductsMegaMenu = () => (
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <Link href="/products/edtech-platform" className="card hover:shadow-xl transition-all group">
      ...
      <Link href="/products/home-automation" className="card hover:shadow-xl transition-all group">
      ...
      <Link href="/products/temple-management" className="card hover:shadow-xl transition-all group">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="space-y-4">
        ...
        <Link href="/blog/future-of-ai-in-business-2025" className="block p-4 border border-neutral-200 rounded-lg hover:border-primary-blue hover:shadow-md transition-all group">
        ...
        <Link href="/blog/digital-transformation-healthcare-guide" className="block p-4 border border-neutral-200 rounded-lg hover:border-primary-blue hover:shadow-md transition-all group">
      ...
      <div className="space-y-4">
        ...
        <Link href="/blog" className="block p-4 border border-neutral-200 rounded-lg hover:border-primary-blue hover:shadow-md transition-all group">
        ...
        <Link href="/case-studies" className="block p-4 border border-neutral-200 rounded-lg hover:border-primary-blue hover:shadow-md transition-all group">
...
const AboutMegaMenu = () => (
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      <Link href="/about" className="card hover:shadow-xl transition-all group">
      ...
      <Link href="/careers" className="card hover:shadow-xl transition-all group">
      ...
      <Link href="/case-studies" className="card hover:shadow-xl transition-all group">
      ...
      <Link href="/contact" className="card hover:shadow-xl transition-all group">
