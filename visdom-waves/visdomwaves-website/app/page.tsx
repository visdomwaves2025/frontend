          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col items-center justify-center min-h-[600px] text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-up">
                <Link href="/products" className="btn-primary bg-white text-primary-blue hover:bg-neutral-100">
                  Explore Our Products
                </Link>
                <Link href="/contact" className="btn-outline border-white text-white hover:bg-white hover:text-primary-blue">
                  Let's Talk
                </Link>
              </div>
        ...
        <section className="py-20 bg-primary-blue text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="btn-primary bg-white text-primary-blue hover:bg-neutral-100 inline-flex items-center">
                Schedule a Call
                <FiArrowRight className="ml-2" />
              </Link>
              <Link href="/products" className="btn-outline border-white text-white hover:bg-white hover:text-primary-blue">
                Try Our Products
              </Link>
            </div>
          </div>
