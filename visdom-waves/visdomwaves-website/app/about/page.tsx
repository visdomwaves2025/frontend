...
export const metadata: Metadata = {
  title: "About Us | VisdomWaves Innovations - Leadership & Vision",
  description: "Meet the expert team behind VisdomWaves Innovations. Learn about our mission, vision, and core values driving digital transformation across industries.",
  openGraph: {
    title: "About VisdomWaves Innovations",
    description: "Expert leadership in AI and digital transformation",
  },
};
        ...
        <section className="py-20 bg-primary-navy text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="btn-primary bg-brand-vibrantTeal hover:bg-primary-blue">
                Let's Talk
              </Link>
              <Link href="/careers" className="btn-outline border-white text-white hover:bg-white hover:text-primary-navy">
                Join Our Team
              </Link>
            </div>
          </div>
