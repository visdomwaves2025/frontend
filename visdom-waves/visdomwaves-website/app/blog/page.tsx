...
export const metadata: Metadata = {
  title: "Blog | VisdomWaves Insights on AI, Technology & Digital Transformation",
  description: "Expert insights, industry trends, and best practices in AI, digital transformation, healthcare technology, EdTech, and enterprise solutions.",
  openGraph: {
    title: "VisdomWaves Blog",
    description: "Thought leadership in AI and digital transformation",
  },
};
