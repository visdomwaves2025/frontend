      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-neutral-50 border-b border-neutral-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <Link
              href="/blog"
              className="inline-flex items-center text-primary-blue hover:text-primary-navy font-semibold"
            >
        ...
        <article className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-6">
              ...
              {post.featured && (
                <span className="ml-2 px-4 py-2 bg-yellow-100 text-yellow-700 rounded-full text-sm font-semibold">
                  Featured Article
                </span>
              )}
            </div>
            ...
            {/* Title */}
            <h1 className="text-display-md font-heading text-primary-navy mb-6 leading-tight">
              {post.title}
            </h1>
