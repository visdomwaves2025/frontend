...
export const metadata: Metadata = {
  title: "Careers | Join VisdomWaves Innovations Team",
  description:
    "Join our innovative team and build the future of technology. Explore open positions in engineering, design, consulting, and more.",
  openGraph: {
    title: "Careers at VisdomWaves",
    description: "Build the future with us - explore open positions",
  },
};
