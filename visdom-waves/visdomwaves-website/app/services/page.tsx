...
export const metadata: Metadata = {
  title: "Our Services | VisdomWaves - AI, Web & App Development Solutions",
  description: "Comprehensive technology services including AI/ML solutions, web development, mobile apps, cloud computing, and digital transformation consulting.",
  openGraph: {
    title: "VisdomWaves Services",
    description: "End-to-end technology solutions for modern businesses",
  },
};
import {
  FiBriefcase,
