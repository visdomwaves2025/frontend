...
function getChallengeIcon(industrySlug: string, challengeIndex: number) {
  // Education industry
  if (industrySlug === 'education') {
    const educationIcons = [
      <FiBook className="w-6 h-6 text-primary-blue" />, // Fragmented Learning Experiences
      <FiUsers className="w-6 h-6 text-primary-blue" />, // Student Engagement Challenges
      <FiBarChart2 className="w-6 h-6 text-primary-blue" />, // Data Management Complexity
    ];
  ...
  if (industrySlug === 'healthcare') {
    const healthcareIcons = [
      <FiDatabase className="w-6 h-6 text-primary-blue" />, // Fragmented Patient Data
      <FiHeart className="w-6 h-6 text-primary-blue" />, // Limited Access to Care
      <FiSettings className="w-6 h-6 text-primary-blue" />, // Operational Inefficiencies
      <FiShield className="w-6 h-6 text-primary-blue" />, // Compliance Complexity
    ];
  ...
  if (industrySlug === 'technology') {
    const technologyIcons = [
      <FiTrendingUp className="w-6 h-6 text-primary-blue" />, // Rapid Scaling Demands
      <FiTool className="w-6 h-6 text-primary-blue" />, // Technical Debt
      <FiCloud className="w-6 h-6 text-primary-blue" />, // Security Vulnerabilities
      <FiUsers className="w-6 h-6 text-primary-blue" />, // Talent Acquisition & Retention
    ];
...
function getCaseStudyIcon(industrySlug: string, section: string) {
  // Education industry
  if (industrySlug === 'education') {
